exports.FormField = React.createClass({displayName: "FormField",
  ...
  render: function(){
    return(
      React.createElement("input", {type: this.state.type, name: this.state.name, onChange: this.handleChange, className: this.state.className, onBlur: this.validate, value: this.state.value})
    )
  }
